...
ENG_FREQ = [0.0749, 0.0129, 0.0354, 0.0362, 0.1400, 0.0218, 0.0174, 0.0422, 0.0665, 0.0027, 0.0047, 0.0357, 0.0339,
...
def decode(ciphertext, key=None, minkeysize=3, maxkeysize=25):
    if key == None:
        try:
            ...
            raise Exception("Key could not be deduced")
    return decode_with_key(ciphertext, key), key
